...
class DispersionPaymentTest(unittest.TestCase):
    ...
    def test_dispersion_payment_initialization(self):
        ...
        data = {
            ...
            "dispersion": [
                ...
                {"reference": "DISP002", "description": "Split Payment 2", "amount": {"currency": "COP", "total": 1000}},
            ],
        }
    ...
    def test_dispersion_to_dict(self):
        ...
        expected_dispersion = [{'reference': 'DISP001', 'description': 'Split Payment 1', 'amount': {'currency': 'USD', 'total': 50.0, 'taxes': [], 'details': [], 'tip': None, 'insurance': None}, 'allowPartial': False, 'shipping': None, 'items': [], 'recurring': None, 'discount': None, 'subscribe': False, 'agreement': None, 'agreementType': '', 'modifiers': [], 'fields': []}, {'reference': 'DISP002', 'description': 'Split Payment 2', 'amount': {'currency': 'USD', 'total': 50.0, 'taxes': [], 'details': [], 'tip': None, 'insurance': None}, 'allowPartial': False, 'shipping': None, 'items': [], 'recurring': None, 'discount': None, 'subscribe': False, 'agreement': None, 'agreementType': '', 'modifiers': [], 'fields': []}]
    ...
    def test_dispersion_payment_to_dict(self):
        ...
        expected_dict = {'reference': 'REF001', 'description': 'Main Payment', 'amount': {'currency': 'USD', 'total': 100.0, 'taxes': [], 'details': [], 'tip': None, 'insurance': None}, 'allowPartial': False, 'shipping': None, 'items': [], 'recurring': None, 'discount': None, 'subscribe': False, 'agreement': None, 'agreementType': '', 'modifiers': [], 'fields': [], 'dispersion': [{'reference': 'DISP001', 'description': 'Split Payment 1', 'amount': {'currency': 'USD', 'total': 50.0, 'taxes': [], 'details': [], 'tip': None, 'insurance': None}, 'allowPartial': False, 'shipping': None, 'items': [], 'recurring': None, 'discount': None, 'subscribe': False, 'agreement': None, 'agreementType': '', 'modifiers': [], 'fields': []}, {'reference': 'DISP002', 'description': 'Split Payment 2', 'amount': {'currency': 'USD', 'total': 50.0, 'taxes': [], 'details': [], 'tip': None, 'insurance': None}, 'allowPartial': False, 'shipping': None, 'items': [], 'recurring': None, 'discount': None, 'subscribe': False, 'agreement': None, 'agreementType': '', 'modifiers': [], 'fields': []}]}
